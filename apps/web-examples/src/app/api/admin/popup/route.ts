...
export async function GET(request: NextRequest) {
  try {
    ...
    const result = await popupService.getPopupList({
      page,
      pageSize,
      isShow,
      searchType,
...
export async function POST(request: NextRequest) {
  try {
    ...
    const result = await popupService.createPopup(createNoticeRequestDto);
...
export async function DELETE(request: NextRequest) {
  ...
  try {
    const result = await popupService.deletePopup(idList);
...
export async function PUT(request: NextRequest) {
  ...
  try {
    const result = await popupService.updatePopupOrder(idList);
